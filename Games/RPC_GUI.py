...
def result(human_choice,comp_choice):
    ...
    answer="Your Choice: {uc} \nComputer's Choice : {cc} \n Your Score : {u} \n Computer Score : {c}  \n\n made by Parag Durafe ".format(uc=USER_CHOICE,cc=COMP_CHOICE,u=USER_SCORE,c=COMP_SCORE, font=('arial',24,'bold'))
...
button2=tk.Button(text="        Paper          ",bg="green",command=paper, height=1,width=8,font=('arial',15,'bold'))
button2.grid(column=15,row=2)
button3=tk.Button(text="         Rock          ",bg="blue",command=rock, height=1,width=8,font=('arial',15,'bold'))
